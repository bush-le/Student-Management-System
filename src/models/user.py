...
class User:
    ...
    """
    def __init__(self, user_id, username, password, full_name, email, phone, role, status="ACTIVE", failed_login_attempts=0, lockout_time=None, reset_token=None, reset_token_expiry=None):
